...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        with pd.ExcelWriter('exported_db_data.xlsx', engine='openpyxl') as writer:
            ...
            df_commodity_production.to_excel(writer, sheet_name='CommodityProduction', index=False)
            ...
            df_material_proportion.to_excel(writer, sheet_name='MaterialProportion', index=False)
            ...
            df_commodity_price.to_excel(writer, sheet_name='CommodityPrice', index=False)
